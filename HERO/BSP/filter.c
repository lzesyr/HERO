...
//鼠标平均滤波
int16_t AverageFilerData[30]={0,};
int32_t ReturnFilerData = 0;
int16_t AverageFiler(int newData)
{
	int num=0;
	AverageFilerData[29] = newData;
	for(num=0;num<29;num++)
	{
		AverageFilerData[num] = AverageFilerData[num+1];
	}
	for(num=0;num<30;num++)
	{
		ReturnFilerData +=AverageFilerData[num];
	}
	ReturnFilerData = ReturnFilerData/30;
	ReturnFilerData = (int16_t)ReturnFilerData;
	return ReturnFilerData;
}
